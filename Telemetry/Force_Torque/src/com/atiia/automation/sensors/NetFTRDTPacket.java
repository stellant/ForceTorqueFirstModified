...
public class NetFTRDTPacket {
    ...
    private int m_uiRDTSequence; /*the number of the packet. increments by 
        ...
        public String toString()
        {
			...
			output.append(getRDTSequence()+" ");
			output.append(getFTSequence()+" ");
        ...
        public String toString(double[] count)
        {
        	StringBuilder output = new StringBuilder();
			output.append(getRDTSequence()+" ");
			output.append(getFTSequence()+" ");
			output.append(getStatus()+" ");
			output.append(getFx()/count[0]+" ");
			output.append(getFy()/count[1]+" ");
			output.append(getFz()/count[2]+" ");
			output.append(getTx()/count[3]+" ");
			output.append(getTy()/count[4]+" ");
			output.append(getTz()/count[5]+" ");
			output.append(new Date()+"");
			return output.toString();
        }
   }
